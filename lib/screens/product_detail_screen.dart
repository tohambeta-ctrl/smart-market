...
class ProductDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final similar = sampleProducts.where((p) => p.category == product.category && p.id != product.id).toList();
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(product.category, style: theme.textTheme.bodyMedium?.copyWith(color: Colors.grey.shade700)),
                ...
                Text('per ${product.unit}', style: theme.textTheme.bodyMedium),
              ],
            ),
          ),
          const SizedBox(height: 16),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _InfoRow(Icons.location_on_outlined, 'Location', product.location),
                  const Divider(height: 20),
                  _InfoRow(Icons.star_outline, 'Rating', '${product.rating} (${product.reviewCount} reviews)'),
                ],
              ),
            ),
          ),
          ...
          if (similar.isNotEmpty) ...[
            ...
            Text(
              'Other sellers in ${product.category}',
          ...
          children: [
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(other.sellerName, style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w500)),
                  Text(other.location, style: theme.textTheme.bodySmall?.copyWith(color: Colors.grey)),
                ],
              ),
            ),
            Column(
              ...
              children: [
                Text(
                  'KES ${other.price.toStringAsFixed(2)}',
                  style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold),
                ),
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                  decoration: BoxDecoration(
                    color: isCheaper ? Colors.green.shade50 : Colors.red.shade50,
